...
export function CvManager() {
  ...
  return (
    <div>
      <label className="mb-6 inline-flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-violet-600 px-5 py-2.5 text-sm text-white">
      ...
      <div className="space-y-3">
        {files.map((f) => (
          <div key={f.id} className={`flex items-center justify-between rounded-xl border p-4 ${f.is_active ? "border-emerald-500/30 bg-emerald-500/5" : "border-white/10 bg-white/[0.03]"}`}>
            <div>
