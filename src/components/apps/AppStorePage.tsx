      ...
      <main className="pt-24">
        <section className="relative overflow-hidden pb-16 md:pb-24">
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:items-start lg:gap-14"
            >
              {/* Left: app identity + meta + download */}
              <div>
                <motion.div variants={fadeUp} className="mb-6 flex items-start gap-5">
                ...
                <motion.div variants={fadeUp} className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
                  {[
                    ...
                    <div key={item.label} className="rounded-xl border border-white/[0.08] bg-white/[0.03] px-3 py-3 text-center">
        ...
        {(prev || next) && (
          <section className="border-t border-white/[0.06] py-10">
            <div className="mx-auto flex max-w-7xl justify-between gap-4 px-6 lg:px-8">
              {prev ? (
